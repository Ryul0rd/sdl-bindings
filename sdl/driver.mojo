...
var _get_render_driver_info = _sdl.get_function[fn (Int, UnsafePointer[RendererInfo]) -> Int](
...
fn get_render_drive_info(index: Int) raises -> RendererInfo:
    ...
    if _get_render_driver_info(index, UnsafePointer.address_of(renderer_info)) != 0:
        raise get_error()
